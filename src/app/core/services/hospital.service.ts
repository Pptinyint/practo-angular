  ...
  // getAppointmentsByHospitalId(id: number): Observable<IApiResponse<IAppointment[]>> {
  //   return this.http.get<IApiResponse<IAppointment[]>>(
  //     environment.api_url + Constant.API_END_POINT.GET_APPOINTMENTS_BY_HOSTPITAL_ID + "/" + id
  //   );
  // }
